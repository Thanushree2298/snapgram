...
export async function saveUserToDB(user: {
  ...
  export async function deletePost(postId?: string, ImageID?: string): Promise<{ status: string }> {
    if (!postId || !ImageID) {
      console.error('Invalid postId or ImageID');
      throw new Error('Invalid postId or ImageID');
    }
  
    try {
      console.log('Deleting post document with ID:', postId, ImageID);
      console.log('Database ID:', appwriteConfig.databaseId);
      console.log('Collection ID:', appwriteConfig.postCollectionId);
      ...
      console.log('Post document deleted successfully:', promise);
      ...
      throw new Error(`Failed to delete post. Error message: ${error.message}`);
    }
  }
